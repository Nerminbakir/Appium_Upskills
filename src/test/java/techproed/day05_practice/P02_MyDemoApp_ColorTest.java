...
public class P02_MyDemoApp_ColorTest extends MyDemoBaseTest {
    ...
    public void testColor() throws InterruptedException {
        ...
        usernameInputField.click(); // keyboard açılması için clickledik
        ...
        driver.hideKeyboard(); // keyboard'u kapatır.
        Thread.sleep(3000);
...
//        WebElement redCircle = driver.findElement(AppiumBy.accessibilityId("red circle"));
        By redCircle = AppiumBy.accessibilityId("red circle"); // Sayfa değiştiğinde aynı elementi kullanmak istiyorum. StaleElement almamak için By ile tanımladım.
